package org.PK.Spring.Rest.Services.Create.main;

import javax.servlet.ServletContext;
import javax.servlet.ServletRegistration;

import org.PK.Spring.Rest.Services.Create.config.WebConfig;
...
public class ApplicationInitializer implements WebApplicationInitializer {
    ...
    protected AnnotationConfigWebApplicationContext registerAndMapDispatcherServlet(
      ...
      final ServletRegistration.Dynamic dispatcher = servletContext
          .addServlet("createMODULE_NAME_v2_0_DispatcherServlet",
